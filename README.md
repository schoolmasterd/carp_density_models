# Ecological strategies and interactions of co-invading Bighead (_Hypophthalmichthys nobilis_) and Silver carp (_H. molitrix_), informed by causal inference and simple dynamic models
